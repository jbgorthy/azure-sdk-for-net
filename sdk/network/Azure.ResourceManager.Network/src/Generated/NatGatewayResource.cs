...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NatGatewayResource : ArmResource
    {
        ...
        public virtual async Task<Response<NatGatewayResource>> GetAsync(string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _natGatewayClientDiagnostics.CreateScope("NatGatewayResource.Get");
            scope.Start();
            try
            {
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<NatGatewayResource> Get(string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _natGatewayClientDiagnostics.CreateScope("NatGatewayResource.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _natGatewayClientDiagnostics.CreateScope("NatGatewayResource.Delete");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<NatGatewayResource>> UpdateAsync(NetworkTagsObject networkTagsObject, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(networkTagsObject, nameof(networkTagsObject));

            using var scope = _natGatewayClientDiagnostics.CreateScope("NatGatewayResource.Update");
            scope.Start();
            try
            {
                var response = await _natGatewayRestClient.UpdateTagsAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, networkTagsObject, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new NatGatewayResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="networkTagsObject"/> is null. </exception>
        public virtual Response<NatGatewayResource> Update(NetworkTagsObject networkTagsObject, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(networkTagsObject, nameof(networkTagsObject));
            ...
            try
            {
                var response = _natGatewayRestClient.UpdateTags(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, networkTagsObject, cancellationToken);
                return Response.FromValue(new NatGatewayResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<NatGatewayResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _natGatewayClientDiagnostics.CreateScope("NatGatewayResource.AddTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new NatGatewayResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
        ...
        public virtual async Task<Response<NatGatewayResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _natGatewayClientDiagnostics.CreateScope("NatGatewayResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<NatGatewayResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _natGatewayClientDiagnostics.CreateScope("NatGatewayResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
