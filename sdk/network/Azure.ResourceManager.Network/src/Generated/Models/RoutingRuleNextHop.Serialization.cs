...
namespace Azure.ResourceManager.Network.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoutingRuleNextHop>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RoutingRuleNextHop>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RoutingRuleNextHop)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RoutingRuleNextHop>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RoutingRuleNextHop)} does not support '{options.Format}' format.");
            }
        }
