...
namespace Azure.ResourceManager.Network
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="VirtualNetworkGatewayNatRuleResource"/>
    /// from an instance of <see cref="ArmClient"/> using the GetVirtualNetworkGatewayNatRuleResource method.
    /// Otherwise you can get one from its parent resource <see cref="VirtualNetworkGatewayResource"/> using the GetVirtualNetworkGatewayNatRule method.
    /// </summary>
    public partial class VirtualNetworkGatewayNatRuleResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="VirtualNetworkGatewayNatRuleResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="VirtualNetworkGatewayNatRuleResource"/> class for mocking. </summary>
        protected VirtualNetworkGatewayNatRuleResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="VirtualNetworkGatewayNatRuleResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal VirtualNetworkGatewayNatRuleResource(ArmClient client, VirtualNetworkGatewayNatRuleData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal VirtualNetworkGatewayNatRuleResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _virtualNetworkGatewayNatRuleClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Network", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<VirtualNetworkGatewayNatRuleResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _virtualNetworkGatewayNatRuleClientDiagnostics.CreateScope("VirtualNetworkGatewayNatRuleResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<VirtualNetworkGatewayNatRuleResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _virtualNetworkGatewayNatRuleClientDiagnostics.CreateScope("VirtualNetworkGatewayNatRuleResource.Get");
            scope.Start();
            try
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>VirtualNetworkGatewayNatRules_Delete</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2023-04-01</description>
        ...
        {
            using var scope = _virtualNetworkGatewayNatRuleClientDiagnostics.CreateScope("VirtualNetworkGatewayNatRuleResource.Delete");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<VirtualNetworkGatewayNatRuleResource>> UpdateAsync(WaitUntil waitUntil, VirtualNetworkGatewayNatRuleData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _virtualNetworkGatewayNatRuleClientDiagnostics.CreateScope("VirtualNetworkGatewayNatRuleResource.Update");
            scope.Start();
            try
            {
                var response = await _virtualNetworkGatewayNatRuleRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<VirtualNetworkGatewayNatRuleResource> Update(WaitUntil waitUntil, VirtualNetworkGatewayNatRuleData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _virtualNetworkGatewayNatRuleRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data, cancellationToken);
                var operation = new NetworkArmOperation<VirtualNetworkGatewayNatRuleResource>(new VirtualNetworkGatewayNatRuleOperationSource(Client), _virtualNetworkGatewayNatRuleClientDiagnostics, Pipeline, _virtualNetworkGatewayNatRuleRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
