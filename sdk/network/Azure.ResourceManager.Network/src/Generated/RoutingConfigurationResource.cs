...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class RoutingConfigurationResource : ArmResource
    {
        ...
        {
            return GetCachedClient(client => new RoutingRuleCollectionCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<RoutingRuleCollectionResource>> GetRoutingRuleCollectionAsync(string ruleCollectionName, CancellationToken cancellationToken = default)
        {
            return await GetRoutingRuleCollections().GetAsync(ruleCollectionName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="ruleCollectionName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<RoutingRuleCollectionResource> GetRoutingRuleCollection(string ruleCollectionName, CancellationToken cancellationToken = default)
        {
            return GetRoutingRuleCollections().Get(ruleCollectionName, cancellationToken);
        }
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>RoutingConfigurations_Delete</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2023-03-01-preview</description>
