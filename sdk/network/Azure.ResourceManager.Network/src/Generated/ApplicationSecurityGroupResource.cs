...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ApplicationSecurityGroupResource : ArmResource
    {
        ...
        {
            _applicationSecurityGroupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Network", ResourceType.Namespace, Diagnostics);
        ...
        {
            using var scope = _applicationSecurityGroupClientDiagnostics.CreateScope("ApplicationSecurityGroupResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _applicationSecurityGroupClientDiagnostics.CreateScope("ApplicationSecurityGroupResource.Delete");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ApplicationSecurityGroupResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _applicationSecurityGroupClientDiagnostics.CreateScope("ApplicationSecurityGroupResource.AddTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new ApplicationSecurityGroupResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
        ...
        public virtual async Task<Response<ApplicationSecurityGroupResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _applicationSecurityGroupClientDiagnostics.CreateScope("ApplicationSecurityGroupResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<ApplicationSecurityGroupResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _applicationSecurityGroupClientDiagnostics.CreateScope("ApplicationSecurityGroupResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
